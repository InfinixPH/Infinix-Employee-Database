...
function renderDashboard(){
  ...
  setTimeout(()=>{
    ...
    // BAR CHART — premium vertical bars with full region names
    ...
    if(ctxR){
      ...
      _charts.region=new Chart(ctxR,{
        ...
        options:{
          responsive:true,
          maintainAspectRatio:false,
          layout:{padding:{top:28,right:14,bottom:8,left:8}},
          plugins:{
            legend:{display:false},
          ...
          scales:{
            ...
            y:{
              beginAtZero:true,
              max:maxVal?Math.ceil(maxVal*1.18):10,
              grid:{color:gridColor,drawTicks:false},
              border:{display:false},
              ticks:{font:{size:10,weight:'700'},color:tickColor,precision:0,padding:8}
            }
          },
          animation:{
