    ...
    if(ctxR){
      ...
      _charts.region=new Chart(ctxR,{
        ...
        options:{
          responsive:true,
          maintainAspectRatio:false,
          layout:{padding:{top:32,right:8,bottom:4,left:8}},
          plugins:{
            legend:{display:false},
          ...
          scales:{
            x:{
              ...
              ticks:{font:{size:10,weight:'700'},color:tickColor,maxRotation:30,minRotation:0}
            },
            y:{
              beginAtZero:true,
              max:maxVal?Math.ceil(maxVal*1.28):10,
