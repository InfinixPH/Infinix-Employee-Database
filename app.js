...
// ============================================================
// SIDEBAR COLLAPSE — REMOVED (was causing layout issues)
// ============================================================
function initSidebar(){ /* collapse feature removed */ }
...
function showView(v){
  ...
  bulkMode=false;
  selectedIds.clear();
  // Always clear filterStatus when clicking a main nav item so it doesn't conflict
  filterStatus=null;
  missingFieldFilter=null;
  currentPage=1;
  document.querySelectorAll('.nav-item').forEach(el=>el.classList.remove('active'));
...
function renderView(){
  ...
  if(currentView==='dashboard')renderDashboard().catch(e=>console.warn('Dashboard render error:',e));
